...
logical value true or false depending on if the integer is a 
prime.
...
You can not assume that the integer will be only positive. You 
may be given negative numbers as well ( or 0 ).
